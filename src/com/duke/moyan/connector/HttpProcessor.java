...
import com.duke.moyan.connector.ServletProcessor;
import com.duke.moyan.connector.StaticResourceProcessor;
...
import com.duke.moyan.request.HttpRequestLine;
import com.duke.moyan.request.HttpSocketInputStream;
import com.duke.moyan.response.HttpResponse;
import com.duke.moyan.util.RequestUtil;
import com.duke.moyan.util.StringManager;
...
public class HttpProcessor implements Runnable{
	...
	protected StringManager sm = StringManager
			.getManager("com.duke.moyan.connector");

	@SuppressWarnings("deprecation")
	public void process(Socket socket) {
		HttpSocketInputStream input = null;
		OutputStream output = null;
		try {
			input = new HttpSocketInputStream(socket.getInputStream(), 2048);
	 ...
	 */
	private void parseHeaders(HttpSocketInputStream input) throws IOException,
			ServletException {
		while (true) {
	...
	private void parseRequest(HttpSocketInputStream input, OutputStream output)
